...
import com.example.eventure.databinding.EmployeePackageDetailsFragmentBinding;
...
public class EmployeePackageDetailsFragment extends Fragment {

    private Package packageItem;
    EmployeePackageDetailsFragmentBinding binding;
    ...
    public EmployeePackageDetailsFragment() {
        // Required empty public constructor
    }


    public static EmployeePackageDetailsFragment newInstance(Package packageItem) {
        EmployeePackageDetailsFragment fragment = new EmployeePackageDetailsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = EmployeePackageDetailsFragmentBinding.inflate(inflater, container, false);
        ...
        btnGoBack.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                fragmentManager.popBackStack(String.valueOf(R.id.employee_packages_fragment_container), FragmentManager.POP_BACK_STACK_INCLUSIVE);
            }
        });
